        ...
        <MDBModalContent>
          ...
          <MDBModalBody>
            ...
            <MDBRow className="mb-4">
              ...
              <MDBCol md="4"><small>{t('payment_month')}</small><p className="fw-bold">{formatDate(paymentRequest.payment_month, i18n.language)}</p></MDBCol>
            ...
            {!isLoading && registerPaymentFormGroups.map(group => (
              <div key={group.groupTitle} className="my-4">
